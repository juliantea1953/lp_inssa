...
<html lang="en">
  ...
  <body>
              ...
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-12 col-lg-10">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=573102242724" class="btn btn-primary py-3 px-5 color_boton"
                      >Contáctanos</a
                    >
                  </div>
                </div>
    ...
    <option value="4">Enfermedades de la piel</option>
                    ...
                    <label id="ciudadd" for="ciudad">Ciudad</label>
...
"correo" => $_POST['gmail'],
"celular" => $_POST['cname'],
"municipio" => $_POST['cage'],
"ciudad" => $_POST['cagec'],
"producto" => $_POST["message"],
...
$uri="mongodb+srv://invitadoICS:InvICS2020@inssacs.rekt9.mongodb.net";
...
echo "Inserted with Object ID '{$insert}'"; */
